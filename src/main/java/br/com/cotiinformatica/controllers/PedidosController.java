...
public class PedidosController {
	...
	@GetMapping
	@Operation(summary = "Obter uma lista de pedidos", description = "Endpoint para obeter uma lista de pedidos existente.")
	public ResponseEntity<Page<PedidoResponse>> get(@RequestParam(defaultValue = "0") int pagina,
